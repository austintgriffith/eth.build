    ...
    <Layout location={location} title={siteTitle}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="relative aspect-16x9">
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/mhwSGYRmkEU"
                frameBorder="0"
                allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
            ...
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Look Ahead: Transactions</h2>
              <ul className="list-spaced mt-4 text-md md:text-lg">
      ...
      <section className="my-8 py-20">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Side Quest: Encryption</h2>
            ...
            <div className="relative aspect-16x9">
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/LGEBqz1uG1U"
                frameBorder="0"
                allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
      ...
      <section className="my-8 py-20">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Byzantine Generals</h2>
            ...
            <div className="relative aspect-16x9">
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/c7yvOlwBPoQ"
                frameBorder="0"
                allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="relative aspect-16x9">
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/zcX7OJ-L8XQ"
                frameBorder="0"
                allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
            ...
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Blockchain</h2>
              <ul className="list-spaced mt-4 text-md md:text-lg">
      ...
      <section className="my-8 py-20">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Transactions</h2>
            ...
            <div className="relative aspect-16x9">
              <iframe
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/er-0ihqFQB0"
                frameBorder="0"
                allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
      ...
      <section className="my-8 py-20 bg-gray-800 text-white">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h2 className="mt-4 lg:mt-0 text-4xl font-semibold">Smart Contracts</h2>
              <ul className="list-spaced mt-4 text-md md:text-lg">
                <li>
      ...
      <div style={{padding:40,paddingBottom:120, textAlign:'center'}}>
